  ...
  return (
    <section id="pricing" className="px-4 py-24">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-3 text-gray-500 dark:text-gray-400">Start free. Upgrade when you need more.</p>
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <p className="mt-4 text-4xl font-bold">
                {tier.price}
                {tier.price !== 'TBD' && <span className="text-lg font-normal text-gray-500 dark:text-gray-400">/forever</span>}
              </p>
              ...
              <div className="mt-8">
                {tier.disabled ? (
                  <button
                    disabled
                    className="w-full rounded-lg border border-gray-300 dark:border-white/20 bg-gray-50 dark:bg-white/5 px-4 py-2.5 text-sm font-medium text-gray-400 cursor-not-allowed"
                  >
                    {tier.cta}
                  </button>
                ) : (
