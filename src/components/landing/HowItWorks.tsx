  ...
  return (
    <section className="px-4 py-24">
      <div className="mx-auto max-w-5xl text-center">
        ...
        <p className="mt-3 text-gray-500 dark:text-gray-400">Three simple steps to a live chat widget on your site.</p>

        <div className="mt-14 grid gap-8 sm:grid-cols-3">
          {steps.map((step) => (
            <div
              key={step.number}
              className="relative rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-6 text-center"
            >
